...
function makeQueryClient() {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$queryClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClient"]({
        defaultOptions: {
            queries: {
                staleTime: 1000 * 60 * 5,
                // 5 minutes — data is "fresh" for this long
                gcTime: 1000 * 60 * 30,
                // 30 minutes — cache kept in memory
...
function Providers(t0) {
    ...
    if ($[0] !== "b45f59f7a3965612e4d00a13b8c21dbe3d4808d8007c774fa44c64aec29bee94") {
        for(let $i = 0; $i < 4; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "b45f59f7a3965612e4d00a13b8c21dbe3d4808d8007c774fa44c64aec29bee94";
    }
    const { children } = t0;
    let t1;
...
//# sourceMappingURL=src_app_provider_2a6fcf59.js.map
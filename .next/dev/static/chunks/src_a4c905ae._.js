...
const SkeletonRow = ()=>{
    ...
    if ($[0] !== "b7bbcf1a2cab9cde7c74ce46fefc8ebb880d308d50bbba061766c62effca41ac") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "b7bbcf1a2cab9cde7c74ce46fefc8ebb880d308d50bbba061766c62effca41ac";
    }
    let t0;
...
const AdminDoctor = ()=>{
    ...
    const limit = 5;
    const filteredResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDoctor.useMemo[filteredResponse]": ()=>{
            return response.filter({
                "AdminDoctor.useMemo[filteredResponse]": (item)=>{
                    return item?.name?.toLowerCase().includes(searchTerm.toLowerCase()) || item?.doctor?.age?.toString().includes(searchTerm.toLowerCase()) || item?.doctor?.gender?.toLowerCase().includes(searchTerm.toLowerCase()) || item?.doctor?.specialization?.toLowerCase().includes(searchTerm.toLowerCase()) || item?.doctor?.experience?.toLowerCase().includes(searchTerm.toLowerCase()) || item?.email?.toLowerCase().includes(searchTerm.toLowerCase());
                }
            }["AdminDoctor.useMemo[filteredResponse]"]);
        }
    }["AdminDoctor.useMemo[filteredResponse]"], [
    ...
    const getDoctor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminDoctor.useCallback[getDoctor]": async ()=>{
            if (!session?.token) {
            ...
            try {
                ...
                console.error(err);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("error", err?.response?.data?.message || "Failed to fetch doctors");
            } finally{
                setLoading(false);
            }
        }
    }["AdminDoctor.useCallback[getDoctor]"], [
        session?.token,
        page,
        limit
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDoctor.useEffect": ()=>{
    ...
    const deleteDoctor = async ()=>{
        ...
        try {
            setIsDeleting(true);
            const res_0 = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiCall$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].delete(`/doctor/delDoctor/${deleteId}`, {
                headers: {
                    Authorization: `Bearer ${session.token}`
                }
            });
            ...
            setDeleteId(null);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("success", res_0?.data?.message || "Doctor deleted successfully");
        } catch (err_0) {
            console.error(err_0);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])("error", err_0?.response?.data?.message || "Failed to delete doctor");
        } finally{
            setIsDeleting(false);
            getDoctor();
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    children: [
                        ...
                        !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                                mode: "popLayout",
                                children: filteredResponse.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                    initial: {
                                        opacity: 0
                                    },
                                    animate: {
                                    ...
                                    lineNumber: 130,
                                    columnNumber: 50
                                }, ("TURBOPACK compile-time value", void 0)) : filteredResponse.map((items, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                        layout: true,
                                        initial: {
                                            opacity: 0,
                                            y: 10
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                children: deleteId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AdminDoctor, "MBjWUll9pVzfUegXzR8K2U2UqvA=", false, function() {
    return [
...
//# sourceMappingURL=src_a4c905ae._.js.map
...
const AdminDoctor = ()=>{
    ...
    const getDoctor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!session?.token) {
        ...
        try {
            ...
            console.error(err);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("error", err?.response?.data?.message || "Failed to fetch doctors");
        } finally{
            setLoading(false);
        }
    }, [
    ...
    const deleteDoctor = async ()=>{
        ...
        try {
            setIsDeleting(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiCall$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].delete(`/doctor/delDoctor/${deleteId}`, {
                headers: {
                    Authorization: `Bearer ${session.token}`
                }
            });
            ...
            setDeleteId(null);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("success", res?.data?.message || "Doctor deleted successfully");
        } catch (err) {
            console.error(err);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("error", err?.response?.data?.message || "Failed to delete doctor");
        } finally{
            setIsDeleting(false);
            getDoctor();
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31523e0a._.js.map
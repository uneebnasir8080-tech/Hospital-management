...
const Booking = ({ onClose, docId, Loading, patientId })=>{
    ...
    // ---------------- API ----------------
    const fetchDoctorSchedule = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            console.error(error);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("error", error?.response?.data?.message || "Failed to fetch doctor schedule");
        }
    }, [
        session?.token,
        docId
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiCall$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/patient/appointment", payload, {
                headers: {
                    Authorization: `Bearer ${session.token}`
                }
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5c9a6a20._.js.map
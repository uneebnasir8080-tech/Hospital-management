...
const AdminPatient = ({ refresh })=>{
    ...
    const getPatient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!session?.token) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("error", "Authentication token missing");
            return;
        }
        try {
            setLoading(true);
            ...
            console.error(err);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("error", err?.response?.data?.message || "Failed to fetch patients");
        } finally{
            setLoading(false);
        }
    }, [
    ...
    const deletePatient = async ()=>{
        ...
        try {
            setIsDeleting(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiCall$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].delete(`/patient/${deleteId}`, {
                headers: {
                    Authorization: `Bearer ${session.token}`
                }
            });
            ...
            setDeleteId(null);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("success", res?.data?.message || "Patient deleted successfully");
        } catch (err) {
            console.error(err);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("error", err?.response?.data?.message || "Failed to delete patient");
        } finally{
            setIsDeleting(false);
            getPatient();
        }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        !loading && filteredPatients.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
const RegData = ({ onClose, ids })=>{
    ...
    const handleOnSubmit = async (values)=>{
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("error", error.response?.data?.message || "Upload failed");
        } finally{
            setIsLoading(false);
        }
    };
...
const RegPatient = ({ onClose })=>{
    ...
    const handleOnSubmit = async (values, e)=>{
        try {
            setIsLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$apiCall$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/create", values);
            const ids = res?.data.data.id;
            setStoreId(ids);
            // Success handling
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("success", res.data.message || "Account created successfully");
            form.reset();
            setNext(()=>!next);
        } catch (error) {
            const message = error.response?.data?.message || "Something went wrong. Please try again.";
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$showToastify$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["showToast"])("error", message);
        } finally{
            setIsLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2df831d3._.js.map
...
export default async function ProfilePage() {
  ...
  if (!session?.token || !session?.id) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="p-8 bg-white rounded-3xl shadow-xl border border-slate-100 text-center">
          <p className="text-xl font-bold text-slate-800">Session Expired</p>
  ...
  const infoItems = [
    ...
    { icon: <Calendar size={20} />, label: "Age", value: `${age} years` },
          ...
          <div className="relative group animate-in fade-in slide-in-from-bottom-5 duration-700">
            ...
            <div className="relative p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="relative">
                <div className="w-32 h-32 md:w-40 md:h-40 rounded-3xl overflow-hidden border-4 border-white shadow-xl relative">
                  <Image
                    src={profileImage}
                    alt="Profile"
                    fill
              ...
              <EditProfileButton resData={resData} />
            </div>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* ---------------- PERSONAL INFO ---------------- */}
            <div className="lg:col-span-2 space-y-6 animate-in fade-in slide-in-from-left-5 duration-700 delay-150">

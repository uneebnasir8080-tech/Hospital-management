...
const ClientProfile = ({ resData }) => {
  ...
  return (
    <div className="h-screen flex flex-col bg-white">
      {/* ---------------- HEADER (FIXED) ---------------- */}
      <div className="text-lg md:text-2xl font-semibold flex items-center justify-between p-4 bg-white sticky top-0 z-50 shadow-sm">
        <h1>My Profile</h1>
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-10">
        ...
        <div className="relative bg-blue-300 rounded-2xl w-[90%] md:w-[55%] mx-auto my-20 pt-16 pb-6 px-4 shadow-md">
          ...
          <MdEdit
            ...
            className="absolute top-4 right-4 cursor-pointer text-xl md:text-2xl text-gray-700 hover:text-black transition"
          />
        ...
        <div className="text-md md:text-xl text-gray-600 space-y-5">
          ...
          <p className="flex gap-3 text-sm md:text-xl">
            History:
            <span className="text-black">
              {resData?.patient?.history || "Reports"}
            </span>
          </p>
        </div>

...
const AdminNewAppoint = () => {
  ...
  return (
    <div className="px-10">
      ...
      <div className="">
        {/* heading  */}
        <div className="grid grid-cols-6 justify-center border-b-2 pb-2">
        ...
        {data.map((items, index) => (
          <div key={index} className="grid grid-cols-6 w-full border-b py-3 ">
            {/* data  */}
            ...
            <div className="flex justify-between grird ">
              <button className="text-blue-600 pl-2 cursor-pointer">
                {items.link}
              </button>
              <Button className="mr-2 bg-red-400 cursor-pointer hover:bg-red-500">
                X
              </Button>
            </div>
          </div>
      ...
      <div className="py-2 text-sm flex justify-end">

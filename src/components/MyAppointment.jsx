  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-black text-slate-800 tracking-tight uppercase">My Consultations</h2>
          ...
          <AnimatePresence>
            {loading ? (
              ...
              resData.map((data, index) => (
                ...
                >
                  <Card className="group border-none bg-white hover:bg-slate-50 transition-all duration-300 rounded-[2.5rem] shadow-sm hover:shadow-xl hover:shadow-blue-500/5 ring-1 ring-slate-100 overflow-hidden">
                    <CardContent className="flex flex-col sm:flex-row items-center gap-6 p-6">
                      ...
                      <div className="flex-1 text-center sm:text-left min-w-0">
                        <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mb-2">
                          <span className="text-[9px] font-black text-blue-600 uppercase tracking-widest px-2.5 py-1 bg-blue-50 rounded-full border border-blue-100">Confirmed Visit</span>
                          <span className="flex items-center gap-1 text-[9px] font-black text-amber-600 uppercase tracking-widest px-2.5 py-1 bg-amber-50 rounded-full border border-amber-100">
                            <Sparkles size={10} /> In-Hospital
                          </span>
                        </div>
                        
                        <h3 className="font-black text-slate-800 text-xl md:text-2xl tracking-tighter uppercase mb-1 truncate">
                        ...
                        <div className="grid grid-cols-1 xs:grid-cols-2 gap-4">
                          <div className="flex items-center justify-center sm:justify-start gap-2 text-slate-500 font-bold text-[11px] uppercase tracking-wider">
                      ...
                      <div className="flex sm:flex-col items-center gap-3 pt-4 sm:pt-0 sm:pl-6 sm:border-l border-slate-100">
                        <button className="p-3.5 bg-white border border-slate-100 rounded-2xl text-slate-400 hover:text-blue-600 hover:border-blue-100 shadow-sm transition-all active:scale-95 group/btn">
                          <ExternalLink size={18} className="group-hover/btn:scale-110 transition-transform" />
                        </button>
                        <button className="p-3.5 bg-red-50 border border-red-100 rounded-2xl text-red-400 hover:bg-red-500 hover:text-white shadow-sm transition-all active:scale-95 group/btn">

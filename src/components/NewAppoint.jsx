      ...
      {loading && (
        <div className="space-y-4 my-5 px-5">
          {[1, 2, 3, 4].map((item, index) => (
            <Card
              key={item}
              className={`w-full md:w-[50%] py-2 min-h-30 animate-pulse  ${index % 2 !== 0 ? "ml-auto" : "mr-auto"}`}
            >
              <CardContent className={`flex gap-6 items-center h-full   ${index % 2 === 0 ? "flex-row" : "flex-row-reverse"}`}>
                {/* Image Skeleton */}
